(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();var mr={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=function(n,e){if(!n)throw wt(e)},wt=function(n){return new Error("Firebase Database ("+Oo.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=function(n){const e=[];let t=0;for(let i=0;i<n.length;i++){let s=n.charCodeAt(i);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&i+1<n.length&&(n.charCodeAt(i+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++i)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},_c=function(n){const e=[];let t=0,i=0;for(;t<n.length;){const s=n[t++];if(s<128)e[i++]=String.fromCharCode(s);else if(s>191&&s<224){const r=n[t++];e[i++]=String.fromCharCode((s&31)<<6|r&63)}else if(s>239&&s<365){const r=n[t++],o=n[t++],a=n[t++],l=((s&7)<<18|(r&63)<<12|(o&63)<<6|a&63)-65536;e[i++]=String.fromCharCode(55296+(l>>10)),e[i++]=String.fromCharCode(56320+(l&1023))}else{const r=n[t++],o=n[t++];e[i++]=String.fromCharCode((s&15)<<12|(r&63)<<6|o&63)}}return e.join("")},hs={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,i=[];for(let s=0;s<n.length;s+=3){const r=n[s],o=s+1<n.length,a=o?n[s+1]:0,l=s+2<n.length,c=l?n[s+2]:0,u=r>>2,h=(r&3)<<4|a>>4;let d=(a&15)<<2|c>>6,_=c&63;l||(_=64,o||(d=64)),i.push(t[u],t[h],t[d],t[_])}return i.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(xo(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):_c(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,i=[];for(let s=0;s<n.length;){const r=t[n.charAt(s++)],a=s<n.length?t[n.charAt(s)]:0;++s;const c=s<n.length?t[n.charAt(s)]:64;++s;const h=s<n.length?t[n.charAt(s)]:64;if(++s,r==null||a==null||c==null||h==null)throw new mc;const d=r<<2|a>>4;if(i.push(d),c!==64){const _=a<<4&240|c>>2;if(i.push(_),h!==64){const m=c<<6&192|h;i.push(m)}}}return i},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class mc extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Do=function(n){const e=xo(n);return hs.encodeByteArray(e,!0)},Tn=function(n){return Do(n).replace(/\./g,"")},Sn=function(n){try{return hs.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gc(n){return Mo(void 0,n)}function Mo(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!vc(t)||(n[t]=Mo(n[t],e[t]));return n}function vc(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function fs(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(J())}function Tc(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Sc(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Uo(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function kc(){const n=J();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Ac(){return Oo.NODE_ADMIN===!0}function Rc(){try{return typeof indexedDB=="object"}catch{return!1}}function Nc(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{var r;e(((r=s.error)===null||r===void 0?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vo=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=jt(Sn(r[0])||""),t=jt(Sn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},Dc=function(n){const e=Vo(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Mc=function(n){const e=Vo(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var S;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(S||(S={}));const Gc={debug:S.DEBUG,verbose:S.VERBOSE,info:S.INFO,warn:S.WARN,error:S.ERROR,silent:S.SILENT},zc=S.INFO,qc={[S.DEBUG]:"log",[S.VERBOSE]:"log",[S.INFO]:"info",[S.WARN]:"warn",[S.ERROR]:"error"},Kc=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),s=qc[e];if(s)console[s](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ps{constructor(e){this.name=e,this._logLevel=zc,this._logHandler=Kc,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in S))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Gc[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,S.DEBUG,...e),this._logHandler(this,S.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,S.VERBOSE,...e),this._logHandler(this,S.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,S.INFO,...e),this._logHandler(this,S.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,S.WARN,...e),this._logHandler(this,S.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,S.ERROR,...e),this._logHandler(this,S.ERROR,...e)}}const Yc=(n,e)=>e.some(t=>n instanceof t);let vr,yr;function Qc(){return vr||(vr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Jc(){return yr||(yr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Bo=new WeakMap,Bi=new WeakMap,Wo=new WeakMap,Ei=new WeakMap,_s=new WeakMap;function Xc(n){const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(De(n.result)),s()},o=()=>{i(n.error),s()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Bo.set(t,n)}).catch(()=>{}),_s.set(e,n),e}function Zc(n){if(Bi.has(n))return;const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),s()},o=()=>{i(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});Bi.set(n,e)}let Wi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Bi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Wo.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return De(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function eu(n){Wi=n(Wi)}function tu(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(Ci(this),e,...t);return Wo.set(i,e.sort?e.sort():[e]),De(i)}:Jc().includes(n)?function(...e){return n.apply(Ci(this),e),De(Bo.get(this))}:function(...e){return De(n.apply(Ci(this),e))}}function nu(n){return typeof n=="function"?tu(n):(n instanceof IDBTransaction&&Zc(n),Yc(n,Qc())?new Proxy(n,Wi):n)}function De(n){if(n instanceof IDBRequest)return Xc(n);if(Ei.has(n))return Ei.get(n);const e=nu(n);return e!==n&&(Ei.set(n,e),_s.set(e,n)),e}const Ci=n=>_s.get(n);function iu(n,e,{blocked:t,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(n,e),a=De(o);return i&&o.addEventListener("upgradeneeded",l=>{i(De(o.result),l.oldVersion,l.newVersion,De(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),s&&l.addEventListener("versionchange",c=>s(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const su=["get","getKey","getAll","getAllKeys","count"],ru=["put","add","delete","clear"],Ti=new Map;function br(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ti.get(e))return Ti.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,s=ru.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(s||su.includes(t)))return;const r=async function(o,...a){const l=this.transaction(o,s?"readwrite":"readonly");let c=l.store;return i&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),s&&l.done]))[0]};return Ti.set(e,r),r}eu(n=>({...n,get:(e,t,i)=>br(e,t)||n.get(e,t,i),has:(e,t)=>!!br(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ou{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(au(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function au(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Hi="@firebase/app",wr="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ct=Du;function Ho(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i=Object.assign({name:ji,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw Me.create("bad-app-name",{appName:String(s)});if(t||(t=Fo()),!t)throw Me.create("no-options");const r=Rn.get(s);if(r){if(An(t,r.options)&&An(i,r.config))return r;throw Me.create("duplicate-app",{appName:s})}const o=new jc(s);for(const l of Gi.values())o.addComponent(l);const a=new $u(t,i,o);return Rn.set(s,a),a}function jo(n=ji){const e=Rn.get(n);if(!e&&n===ji&&Fo())return Ho();if(!e)throw Me.create("no-app",{appName:n});return e}function Le(n,e,t){var i;let s=(i=Mu[n])!==null&&i!==void 0?i:n;t&&(s+=`-${t}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ie.warn(a.join(" "));return}pt(new Xe(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uu="firebase-heartbeat-database",Vu=1,Gt="firebase-heartbeat-store";let Si=null;function Go(){return Si||(Si=iu(Uu,Vu,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Gt)}catch(t){console.warn(t)}}}}).catch(n=>{throw Me.create("idb-open",{originalErrorMessage:n.message})})),Si}async function Bu(n){try{const t=(await Go()).transaction(Gt),i=await t.objectStore(Gt).get(zo(n));return await t.done,i}catch(e){if(e instanceof Ge)Ie.warn(e.message);else{const t=Me.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(t.message)}}}async function Er(n,e){try{const i=(await Go()).transaction(Gt,"readwrite");await i.objectStore(Gt).put(e,zo(n)),await i.done}catch(t){if(t instanceof Ge)Ie.warn(t.message);else{const i=Me.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ie.warn(i.message)}}}function zo(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qu(n){pt(new Xe("platform-logger",e=>new ou(e),"PRIVATE")),pt(new Xe("heartbeat",e=>new ju(e),"PRIVATE")),Le(Hi,wr,n),Le(Hi,wr,"esm2017"),Le("fire-js","")}qu("");var Ku="firebase",Yu="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Le(Ku,Yu,"app");function gs(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,i=Object.getOwnPropertySymbols(n);s<i.length;s++)e.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(n,i[s])&&(t[i[s]]=n[i[s]]);return t}function qo(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Qu=qo,Ko=new nn("auth","Firebase",qo());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(n,...e){throw vs(n,...e)}function pe(n,...e){return vs(n,...e)}function Yo(n,e,t){const i=Object.assign(Object.assign({},Qu()),{[e]:t});return new nn("auth","Firebase",i).create(e,{appName:n.name})}function Qe(n){return Yo(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function vs(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return Ko.create(n,...e)}function y(n,e,...t){if(!n)throw vs(e,...t)}function ge(n){const e="INTERNAL ASSERTION FAILED: "+n;throw bn(e),new Error(e)}function Ce(n,e){n||ge(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zi(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function Xu(){return Sr()==="http:"||Sr()==="https:"}function Sr(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,t){this.shortDelay=e,this.longDelay=t,Ce(t>e,"Short delay should be less than long delay!"),this.isMobile=fs()||Uo()}get(){return Zu()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rh(n,e){return Tt(n,"POST","/v1/accounts:delete",e)}async function Zo(n,e){return Tt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hh(n,e){const t=await Jo(n,{},async()=>{const i=Et({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=Xo(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Qo.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function dh(n,e){return Tt(n,"POST","/v2/accounts:revokeToken",bs(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ar=new Map;function ye(n){Ce(n instanceof Function,"Expected a class definition");let e=Ar.get(n);return e?(Ce(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Ar.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ra(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(na(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(aa(e))return"Blackberry";if(la(e))return"Webos";if(ia(e))return"Safari";if((e.includes("chrome/")||sa(e))&&!e.includes("edge/"))return"Chrome";if(oa(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function na(n=J()){return/firefox\//i.test(n)}function ia(n=J()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function sa(n=J()){return/crios\//i.test(n)}function ra(n=J()){return/iemobile/i.test(n)}function oa(n=J()){return/android/i.test(n)}function aa(n=J()){return/blackberry/i.test(n)}function la(n=J()){return/webos/i.test(n)}function Is(n=J()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function fh(n=J()){var e;return Is(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ph(){return kc()&&document.documentMode===10}function ca(n=J()){return Is(n)||oa(n)||la(n)||aa(n)||/windows phone/i.test(n)||ra(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ua(n,e=[]){let t;switch(n){case"Browser":t=Nr(J());break;case"Worker":t=`${Nr(J())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Ct}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ch(n,e){const t=ms(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(An(r,e??{}))return s;Ee(s,"already-initialized")}return t.initialize({options:e})}function Th(n,e){const t=(e==null?void 0:e.persistence)||[],i=(Array.isArray(t)?t:[t]).map(ye);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function Sh(n,e,t){const i=Es(n);y(i._canInitEmulator,i,"emulator-config-failed"),y(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=ha(e),{host:o,port:a}=kh(e),l=a===null?"":`:${a}`;i.config.emulator={url:`${r}//${o}${l}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),Ah()}function ha(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function kh(n){const e=ha(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:Or(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:Or(o)}}}function Or(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Ah(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class da{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ge("not implemented")}_getIdTokenResponse(e){return ge("not implemented")}_linkToIdToken(e,t){return ge("not implemented")}_getReauthenticationResolver(e){return ge("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn extends fa{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _t{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,s=!1){const r=await ve._fromIdTokenResponse(e,i,s),o=xr(i);return new _t({user:r,providerId:o,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const s=xr(i);return new _t({user:e,providerId:s,_tokenResponse:i,operationType:t})}}function xr(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _a{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(xn,"1"),this.storage.removeItem(xn),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ga extends _a{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}ga.type="SESSION";const va=ga;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ya(){return typeof _e().WorkerGlobalScope<"u"&&typeof _e().importScripts=="function"}async function Wh(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Hh(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function jh(){return ya()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ea{constructor(e,t,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:t,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Xh;case"linkViaPopup":case"linkViaRedirect":return ed;case"reauthViaPopup":case"reauthViaRedirect":return Zh;default:Ee(this.auth,"internal-error")}}resolve(e){Ce(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ce(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd=10*60*1e3;class ud{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!hd(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!Ca(e)){const s=((i=e.error.code)===null||i===void 0?void 0:i.split("auth/")[1])||"internal-error";t.onError(pe(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=cd&&this.cachedEventUids.clear(),this.cachedEventUids.has(Lr(e))}saveEventToCache(e){this.cachedEventUids.add(Lr(e)),this.lastProcessedEventTime=Date.now()}}function Lr(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Ca({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function hd(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Ca(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gd=new sn(3e4,6e4);function Fr(){const n=_e().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function vd(n){return new Promise((e,t)=>{var i,s,r;function o(){Fr(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Fr(),t(pe(n,"network-request-failed"))},timeout:gd.get()})}if(!((s=(i=_e().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=_e().gapi)===null||r===void 0)&&r.load)o();else{const a=Eh("iframefcb");return _e()[a]=()=>{gapi.load?o():t(pe(n,"network-request-failed"))},wh(`${Ih()}?onload=${a}`).catch(l=>t(l))}}).catch(e=>{throw En=null,e})}let En=null;function yd(n){return En=En||vd(n),En}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kd={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ad=500,Rd=600,Nd="_blank",Pd="http://localhost";class $r{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Od(n,e,t,i=Ad,s=Rd){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const l=Object.assign(Object.assign({},kd),{width:i.toString(),height:s.toString(),top:r,left:o}),c=J().toLowerCase();t&&(a=sa(c)?Nd:t),na(c)&&(e=e||Pd,l.scrollbars="yes");const u=Object.entries(l).reduce((d,[_,m])=>`${d}${_}=${m},`,"");if(fh(c)&&a!=="_self")return xd(e||"",a),new $r(null);const h=window.open(e||"",a,u);y(h,n,"popup-blocked");try{h.focus()}catch{}return new $r(h)}function xd(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dd="__/auth/handler",Md="emulator/auth/handler",Ld=encodeURIComponent("fac");async function Ur(n,e,t,i,s,r){y(n.config.authDomain,n,"auth-domain-config-required"),y(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Ct,eventId:s};if(e instanceof fa){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Vi(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,h]of Object.entries({}))o[u]=h}if(e instanceof rn){const u=e.getScopes().filter(h=>h!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const l=await n._getAppCheckToken(),c=l?`#${Ld}=${encodeURIComponent(l)}`:"";return`${Fd(n)}?${Et(a).slice(1)}${c}`}function Fd({config:n}){return n.emulator?ys(n,Md):`https://${n.authDomain}/${Dd}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bd(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Wd(n){pt(new Xe("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;y(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const l={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:ua(n)},c=new yh(i,s,r,l);return Th(c,t),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),pt(new Xe("auth-internal",e=>{const t=Es(e.getProvider("auth").getImmediate());return(i=>new Vd(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Le(Vr,Br,Bd(n)),Le(Vr,Br,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hd=5*60,jd=$o("authIdTokenMaxAge")||Hd;let Wr=null;const Gd=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>jd)return;const s=t==null?void 0:t.token;Wr!==s&&(Wr=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function zd(n=jo()){const e=ms(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Ch(n,{popupRedirectResolver:Ud,persistence:[Qh,$h,va]}),i=$o("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const r=new URL(i,location.origin);if(location.origin===r.origin){const o=Gd(r.toString());Dh(t,o,()=>o(t.currentUser)),xh(t,a=>o(a))}}const s=Lo("auth");return s&&Sh(t,`http://${s}`),t}function qd(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}bh({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=s=>{const r=pe("internal-error");r.customData=s,t(r)},i.type="text/javascript",i.charset="UTF-8",qd().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Wd("Browser");var Hr={};const jr="@firebase/database",Gr="1.0.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sa=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Yd(e)}}catch{}return new Qd},Ye=Sa("localStorage"),Jd=Sa("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rs="5",Pa="v",Oa="s",xa="r",Da="f",Ma=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,La="ls",Fa="p",Qi="ac",$a="websocket",Ua="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kr="start",mf="close",gf="pLPCommand",vf="pRTLPCB",Wa="id",Ha="pw",ja="ser",yf="cb",bf="seg",wf="ts",If="d",Ef="dframe",Ga=1870,za=30,Cf=Ga-za,Tf=25e3,Sf=3e4;class ct{constructor(e,t,i,s,r,o,a){this.connId=e,this.repoInfo=t,this.applicationId=i,this.appCheckToken=s,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=ln(e),this.stats_=Ns(t),this.urlFn=l=>(this.appCheckToken&&(l[Qi]=this.appCheckToken),Ba(t,Ua,l))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new _f(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Sf)),ef(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Ps((...r)=>{const[o,a,l,c,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Kr)this.id=a,this.password=l;else if(o===mf)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const i={};i[Kr]="t",i[ja]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[yf]=this.scriptTagHolder.uniqueCallbackIdentifier),i[Pa]=Rs,this.transportSessionId&&(i[Oa]=this.transportSessionId),this.lastSessionId&&(i[La]=this.lastSessionId),this.applicationId&&(i[Fa]=this.applicationId),this.appCheckToken&&(i[Qi]=this.appCheckToken),typeof location<"u"&&location.hostname&&Ma.test(location.hostname)&&(i[xa]=Da);const s=this.urlFn(i);this.log_("Connecting via long-poll to "+s),this.scriptTagHolder.addTag(s,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ct.forceAllow_=!0}static forceDisallow(){ct.forceDisallow_=!0}static isAvailable(){return ct.forceAllow_?!0:!ct.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!nf()&&!sf()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=L(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const i=Do(t),s=Ra(i,Cf);for(let r=0;r<s.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,s.length,s[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const i={};i[Ef]="t",i[Wa]=e,i[Ha]=t,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=L(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Ps{constructor(e,t,i,s){this.onDisconnect=i,this.urlFn=s,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=ka(),window[gf+this.uniqueCallbackIdentifier]=e,window[vf+this.uniqueCallbackIdentifier]=t,this.myIFrame=Ps.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){B("frame writing exception"),a.stack&&B(a.stack),B(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||B("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Wa]=this.myID,e[Ha]=this.myPW,e[ja]=this.currentSerial;let t=this.urlFn(e),i="",s=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+za+i.length<=Ga;){const o=this.pendingSegs.shift();i=i+"&"+bf+s+"="+o.seg+"&"+wf+s+"="+o.ts+"&"+If+s+"="+o.d,s++}return t=t+i,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,i){this.pendingSegs.push({seg:e,ts:t,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const i=()=>{this.outstandingRequests.delete(t),this.newRequest_()},s=setTimeout(i,Math.floor(Tf)),r=()=>{clearTimeout(s),i()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const s=i.readyState;(!s||s==="loaded"||s==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),t())},i.onerror=()=>{B("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds extends Ka{constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}static getInstance(){return new Ds}getInitialEvent(e){return p(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ji;function Kf(n){Ji=n}const Xa=function(n){return typeof n=="number"?"number:"+Na(n):"string:"+n},Za=function(n){if(n.isLeafNode()){const e=n.val();p(typeof e=="string"||typeof e=="number"||typeof e=="object"&&fe(e,".sv"),"Priority must be a string or number.")}else p(n===Ji||n.isEmpty(),"priority of unexpected type.");p(n===Ji||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let el,tl;function Yf(n){el=n}function Qf(n){tl=n}class Jf extends si{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?it(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return I.MIN}maxPost(){return new I(Be,new F("[PRIORITY-POST]",tl))}makePost(e,t){const i=el(e);return new I(t,new F("[PRIORITY-POST]",i))}toString(){return".priority"}}const N=new Jf;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class np extends si{compare(e,t){const i=e.node.compareTo(t.node);return i===0?it(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return I.MIN}maxPost(){return I.MAX}makePost(e,t){const i=D(e);return new I(t,i)}toString(){return".value"}}const il=new np;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n extends qa{constructor(e,t,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=ln("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=$n.getListenId_(e,i),a={};this.listens_[o]=a;const l=oo(e._queryParams);this.restRequest_(r+".json",l,(c,u)=>{let h=u;if(c===404&&(h=null,c=null),c===null&&this.onDataUpdate_(r,h,!1,i),Je(this.listens_,o)===a){let d;c?c===401?d="permission_denied":d="rest_error:"+c:d="ok",s(d,null)}})}unlisten(e,t){const i=$n.getListenId_(e,t);delete this.listens_[i]}get(e){const t=oo(e._queryParams),i=e._path.toString(),s=new It;return this.restRequest_(i+".json",t,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,t={},i){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(t.auth=s.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Et(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=jt(a.responseText)}catch{Y("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&Y("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Un(){return{value:null,children:new Map}}function rl(n,e,t){if(E(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=w(e);n.children.has(i)||n.children.set(i,Un());const s=n.children.get(i);e=R(e),rl(s,e,t)}}function Xi(n,e,t){n.value!==null?t(e,n.value):cp(n,(i,s)=>{const r=new k(e.toString()+"/"+i);Xi(s,r,t)})}function cp(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lo=10*1e3,hp=30*1e3,dp=5*60*1e3;class fp{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new up(e);const i=lo+(hp-lo)*Math.random();Ut(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;H(e,(s,r)=>{r>0&&fe(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Ut(this.reportStats_.bind(this),Math.floor(Math.random()*2*dp))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(n,e){return{eventCache:n,serverCache:e}}function Vt(n,e,t,i){return ri(new He(e,t,i),n.serverCache)}function ol(n,e,t,i){return ri(n.eventCache,new He(e,t,i))}function Bn(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function nt(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e){this.writeTree_=e}static empty(){return new de(new A(null))}}function Bt(n,e,t){if(E(e))return new de(new A(t));{const i=n.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=K(s,e);return r=r.updateChild(o,t),new de(n.writeTree_.set(s,r))}else{const s=new A(t),r=n.writeTree_.setTree(e,s);return new de(r)}}}function Zi(n,e,t){let i=n;return H(t,(s,r)=>{i=Bt(i,O(e,s),r)}),i}function co(n,e){if(E(e))return de.empty();{const t=n.writeTree_.setTree(e,new A(null));return new de(t)}}function es(n,e){return st(n,e)!=null}function st(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(K(t.path,e)):null}function uo(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(N,(i,s)=>{e.push(new I(i,s))}):n.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new I(i,s.value))}),e}function $e(n,e){if(E(e))return n;{const t=st(n,e);return t!=null?new de(new A(t)):new de(n.writeTree_.subtree(e))}}function ts(n){return n.writeTree_.isEmpty()}function vt(n,e){return al(T(),n.writeTree_,e)}function al(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(p(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):t=al(O(n,s),r,t)}),!t.getChild(n).isEmpty()&&i!==null&&(t=t.updateChild(O(n,".priority"),i)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oi(n,e){return hl(e,n)}function yp(n,e,t,i,s){p(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Bt(n.visibleWrites,e,t)),n.lastWriteId=i}function bp(n,e,t,i){p(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=Zi(n.visibleWrites,e,t),n.lastWriteId=i}function wp(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function Ip(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);p(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Ep(a,i.path)?s=!1:re(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Cp(n),!0;if(i.snap)n.visibleWrites=co(n.visibleWrites,i.path);else{const a=i.children;H(a,l=>{n.visibleWrites=co(n.visibleWrites,O(i.path,l))})}return!0}else return!1}function Ep(n,e){if(n.snap)return re(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&re(O(n.path,t),e))return!0;return!1}function Cp(n){n.visibleWrites=ll(n.allWrites,Tp,T()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Tp(n){return n.visible}function ll(n,e,t){let i=de.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)re(t,o)?(a=K(t,o),i=Bt(i,a,r.snap)):re(o,t)&&(a=K(o,t),i=Bt(i,T(),r.snap.getChild(a)));else if(r.children){if(re(t,o))a=K(t,o),i=Zi(i,a,r.children);else if(re(o,t))if(a=K(o,t),E(a))i=Zi(i,T(),r.children);else{const l=Je(r.children,w(a));if(l){const c=l.getChild(R(a));i=Bt(i,T(),c)}}}else throw wt("WriteRecord should have .snap or .children")}}return i}function cl(n,e,t,i,s){if(!i&&!s){const r=st(n.visibleWrites,e);if(r!=null)return r;{const o=$e(n.visibleWrites,e);if(ts(o))return t;if(t==null&&!es(o,T()))return null;{const a=t||v.EMPTY_NODE;return vt(o,a)}}}else{const r=$e(n.visibleWrites,e);if(!s&&ts(r))return t;if(!s&&t==null&&!es(r,T()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(re(c.path,e)||re(e,c.path))},a=ll(n.allWrites,o,e),l=t||v.EMPTY_NODE;return vt(a,l)}}}function Sp(n,e,t){let i=v.EMPTY_NODE;const s=st(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(N,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=$e(n.visibleWrites,e);return t.forEachChild(N,(o,a)=>{const l=vt($e(r,new k(o)),a);i=i.updateImmediateChild(o,l)}),uo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=$e(n.visibleWrites,e);return uo(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function kp(n,e,t,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=O(e,t);if(es(n.visibleWrites,r))return null;{const o=$e(n.visibleWrites,r);return ts(o)?s.getChild(t):vt(o,s.getChild(t))}}function Ap(n,e,t,i){const s=O(e,t),r=st(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=$e(n.visibleWrites,s);return vt(o,i.getNode().getImmediateChild(t))}else return null}function Rp(n,e){return st(n.visibleWrites,e)}function Np(n,e,t,i,s,r,o){let a;const l=$e(n.visibleWrites,e),c=st(l,T());if(c!=null)a=c;else if(t!=null)a=vt(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let _=d.getNext();for(;_&&u.length<s;)h(_,i)!==0&&u.push(_),_=d.getNext();return u}else return[]}function Pp(){return{visibleWrites:de.empty(),allWrites:[],lastWriteId:-1}}function Wn(n,e,t,i){return cl(n.writeTree,n.treePath,e,t,i)}function Bs(n,e){return Sp(n.writeTree,n.treePath,e)}function ho(n,e,t,i){return kp(n.writeTree,n.treePath,e,t,i)}function Hn(n,e){return Rp(n.writeTree,O(n.treePath,e))}function Op(n,e,t,i,s,r){return Np(n.writeTree,n.treePath,e,t,i,s,r)}function Ws(n,e,t){return Ap(n.writeTree,n.treePath,e,t)}function ul(n,e){return hl(O(n.treePath,e),n.writeTree)}function hl(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hp{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const i=this.query_._queryParams,s=new Ls(i.getIndex()),r=rp(i);this.processor_=Mp(r);const o=t.serverCache,a=t.eventCache,l=s.updateFullNode(v.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(v.EMPTY_NODE,a.getNode(),null),u=new He(l,o.isFullyInitialized(),s.filtersNodes()),h=new He(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=ri(h,u),this.eventGenerator_=new pp(this.query_)}get query(){return this.query_}}function jp(n){return n.viewCache_.serverCache.getNode()}function Gp(n){return Bn(n.viewCache_)}function zp(n,e){const t=nt(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!E(e)&&!t.getImmediateChild(w(e)).isEmpty())?t.getChild(e):null}function _o(n){return n.eventRegistrations_.length===0}function qp(n,e){n.eventRegistrations_.push(e)}function mo(n,e,t){const i=[];if(t){p(e==null,"A cancel should cancel all event registrations.");const s=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,s);o&&i.push(o)})}if(e){let s=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))s.push(o);else if(e.hasAnyCallback()){s=s.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=s}else n.eventRegistrations_=[];return i}function go(n,e,t,i){e.type===he.MERGE&&e.source.queryId!==null&&(p(nt(n.viewCache_),"We should always have a full cache before handling merges"),p(Bn(n.viewCache_),"Missing event cache, even though we have a server cache"));const s=n.viewCache_,r=Fp(n.processor_,s,e,t,i);return Lp(n.processor_,r.viewCache),p(r.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,pl(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Kp(n,e){const t=n.viewCache_.eventCache,i=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(N,(r,o)=>{i.push(mt(r,o))}),t.isFullyInitialized()&&i.push(sl(t.getNode())),pl(n,i,t.getNode(),e)}function pl(n,e,t,i){const s=i?[i]:n.eventRegistrations_;return _p(n.eventGenerator_,e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gn;class _l{constructor(){this.views=new Map}}function Yp(n){p(!Gn,"__referenceConstructor has already been defined"),Gn=n}function Qp(){return p(Gn,"Reference.ts has not been loaded"),Gn}function Jp(n){return n.views.size===0}function js(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return p(r!=null,"SyncTree gave us an op for an invalid query."),go(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(go(o,e,t,i));return r}}function ml(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Wn(t,s?i:null),l=!1;a?l=!0:i instanceof v?(a=Bs(t,i),l=!1):(a=v.EMPTY_NODE,l=!1);const c=ri(new He(a,l,!1),new He(i,s,!1));return new Hp(e,c)}return o}function Xp(n,e,t,i,s,r){const o=ml(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),qp(o,t),Kp(o,t)}function Zp(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=je(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(mo(c,t,i)),_o(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(mo(l,t,i)),_o(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!je(n)&&r.push(new(Qp())(e._repo,e._path)),{removed:r,events:o}}function gl(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ue(n,e){let t=null;for(const i of n.views.values())t=t||zp(i,e);return t}function vl(n,e){if(e._queryParams.loadsAllData())return ai(n);{const i=e._queryIdentifier;return n.views.get(i)}}function yl(n,e){return vl(n,e)!=null}function je(n){return ai(n)!=null}function ai(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zn;function e_(n){p(!zn,"__referenceConstructor has already been defined"),zn=n}function t_(){return p(zn,"Reference.ts has not been loaded"),zn}let n_=1;class vo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new A(null),this.pendingWriteTree_=Pp(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Gs(n,e,t,i,s){return yp(n.pendingWriteTree_,e,t,i,s),s?kt(n,new tt($s(),e,t)):[]}function i_(n,e,t,i){bp(n.pendingWriteTree_,e,t,i);const s=A.fromObject(t);return kt(n,new gt($s(),e,s))}function xe(n,e,t=!1){const i=wp(n.pendingWriteTree_,e);if(Ip(n.pendingWriteTree_,e)){let r=new A(null);return i.snap!=null?r=r.set(T(),!0):H(i.children,o=>{r=r.set(new k(o),!0)}),kt(n,new Vn(i.path,r,t))}else return[]}function un(n,e,t){return kt(n,new tt(Us(),e,t))}function s_(n,e,t){const i=A.fromObject(t);return kt(n,new gt(Us(),e,i))}function r_(n,e){return kt(n,new Xt(Us(),e))}function o_(n,e,t){const i=zs(n,t);if(i){const s=qs(i),r=s.path,o=s.queryId,a=K(r,e),l=new Xt(Vs(o),a);return Ks(n,r,l)}else return[]}function qn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||yl(o,e))){const l=Zp(o,e,t,i);Jp(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,_)=>je(_));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=c_(d);for(let m=0;m<_.length;++m){const C=_[m],P=C.query,M=El(n,C);n.listenProvider_.startListening(Wt(P),Zt(n,P),M.hashFn,M.onComplete)}}}!h&&c.length>0&&!i&&(u?n.listenProvider_.stopListening(Wt(e),null):c.forEach(d=>{const _=n.queryToTagMap.get(ci(d));n.listenProvider_.stopListening(Wt(d),_)}))}u_(n,c)}return a}function bl(n,e,t,i){const s=zs(n,i);if(s!=null){const r=qs(s),o=r.path,a=r.queryId,l=K(o,e),c=new tt(Vs(a),l,t);return Ks(n,o,c)}else return[]}function a_(n,e,t,i){const s=zs(n,i);if(s){const r=qs(s),o=r.path,a=r.queryId,l=K(o,e),c=A.fromObject(t),u=new gt(Vs(a),l,c);return Ks(n,o,u)}else return[]}function ss(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,_)=>{const m=K(d,s);r=r||Ue(_,m),o=o||je(_)});let a=n.syncPointTree_.get(s);a?(o=o||je(a),r=r||Ue(a,T())):(a=new _l,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=v.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((_,m)=>{const C=Ue(m,T());C&&(r=r.updateImmediateChild(_,C))}));const c=yl(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=ci(e);p(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=h_();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const u=oi(n.pendingWriteTree_,s);let h=Xp(a,e,t,u,r,l);if(!c&&!o&&!i){const d=vl(a,e);h=h.concat(d_(n,e,d))}return h}function li(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=K(o,e),c=Ue(a,l);if(c)return c});return cl(s,e,r,t,!0)}function l_(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=K(c,t);i=i||Ue(u,h)});let s=n.syncPointTree_.get(t);s?i=i||Ue(s,T()):(s=new _l,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new He(i,!0,!1):null,a=oi(n.pendingWriteTree_,e._path),l=ml(s,e,a,r?o.getNode():v.EMPTY_NODE,r);return Gp(l)}function kt(n,e){return wl(e,n.syncPointTree_,null,oi(n.pendingWriteTree_,T()))}function wl(n,e,t,i){if(E(n.path))return Il(n,e,t,i);{const s=e.get(T());t==null&&s!=null&&(t=Ue(s,T()));let r=[];const o=w(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,u=ul(i,o);r=r.concat(wl(a,l,c,u))}return s&&(r=r.concat(js(s,n,i,t))),r}}function Il(n,e,t,i){const s=e.get(T());t==null&&s!=null&&(t=Ue(s,T()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=ul(i,o),u=n.operationForChild(o);u&&(r=r.concat(Il(u,a,l,c)))}),s&&(r=r.concat(js(s,n,i,t))),r}function El(n,e){const t=e.query,i=Zt(n,t);return{hashFn:()=>(jp(e)||v.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?o_(n,t._path,i):r_(n,t._path);{const r=rf(s,t);return qn(n,t,null,r)}}}}function Zt(n,e){const t=ci(e);return n.queryToTagMap.get(t)}function ci(n){return n._path.toString()+"$"+n._queryIdentifier}function zs(n,e){return n.tagToQueryMap.get(e)}function qs(n){const e=n.indexOf("$");return p(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new k(n.substr(0,e))}}function Ks(n,e,t){const i=n.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=oi(n.pendingWriteTree_,e);return js(i,t,s,null)}function c_(n){return n.fold((e,t,i)=>{if(t&&je(t))return[ai(t)];{let s=[];return t&&(s=gl(t)),H(i,(r,o)=>{s=s.concat(o)}),s}})}function Wt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(t_())(n._repo,n._path):n}function u_(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=ci(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function h_(){return n_++}function d_(n,e,t){const i=e._path,s=Zt(n,e),r=El(n,t),o=n.listenProvider_.startListening(Wt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)p(!je(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!E(c)&&u&&je(u))return[ai(u).query];{let d=[];return u&&(d=d.concat(gl(u).map(_=>_.query))),H(h,(_,m)=>{d=d.concat(m)}),d}});for(let c=0;c<l.length;++c){const u=l[c];n.listenProvider_.stopListening(Wt(u),Zt(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ys(t)}node(){return this.node_}}class Qs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=O(this.path_,e);return new Qs(this.syncTree_,t)}node(){return li(this.syncTree_,this.path_)}}const f_=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},yo=function(n,e,t){if(!n||typeof n!="object")return n;if(p(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return p_(n[".sv"],e,t);if(typeof n[".sv"]=="object")return __(n[".sv"],e);p(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},p_=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:p(!1,"Unexpected server value: "+n)}},__=function(n,e,t){n.hasOwnProperty("increment")||p(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const i=n.increment;typeof i!="number"&&p(!1,"Unexpected increment value: "+i);const s=e.node();if(p(s!==null&&typeof s<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const o=s.getValue();return typeof o!="number"?i:o+i},Cl=function(n,e,t,i){return Xs(e,new Qs(t,n),i)},Js=function(n,e,t){return Xs(n,new Ys(e),t)};function Xs(n,e,t){const i=n.getPriority().val(),s=yo(i,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=yo(o.getValue(),e,t);return a!==o.getValue()||s!==o.getPriority().val()?new F(a,D(s)):n}else{const o=n;return r=o,s!==o.getPriority().val()&&(r=r.updatePriority(new F(s))),o.forEachChild(N,(a,l)=>{const c=Xs(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S_{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function di(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!xs(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function Nl(n,e,t){di(n,t),Pl(n,i=>xs(i,e))}function ie(n,e,t){di(n,t),Pl(n,i=>re(i,e)||re(e,i))}function Pl(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(k_(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function k_(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();$t&&B("event: "+t.toString()),St(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",z_=function(){let n=0;const e=[];return function(t){const i=t===n;n=t;let s;const r=new Array(8);for(s=7;s>=0;s--)r[s]=Eo.charAt(t%64),t=Math.floor(t/64);p(t===0,"Cannot push at time == 0");let o=r.join("");if(i){for(s=11;s>=0&&e[s]===63;s--)e[s]=0;e[s]++}else for(s=0;s<12;s++)e[s]=Math.floor(Math.random()*64);for(s=0;s<12;s++)o+=Eo.charAt(e[s]);return p(o.length===20,"nextPushId: Length should be 20."),o}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return E(this._path)?null:Os(this._path)}get ref(){return new me(this._repo,this._path)}get _queryIdentifier(){const e=ao(this._queryParams),t=As(e);return t==="{}"?"default":t}get _queryObject(){return ao(this._queryParams)}isEqual(e){if(e=z(e),!(e instanceof pn))return!1;const t=this._repo===e._repo,i=xs(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Ff(this._path)}}function Y_(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Q_(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===Fe){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",s="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==et)throw new Error(i);if(typeof e!="string")throw new Error(s)}if(n.hasEnd()){if(n.getIndexEndName()!==Be)throw new Error(i);if(typeof t!="string")throw new Error(s)}}else if(n.getIndex()===N){if(e!=null&&!Kn(e)||t!=null&&!Kn(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(p(n.getIndex()instanceof nl||n.getIndex()===il,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class me extends pn{constructor(e,t){super(e,t,new Fs,!1)}get parent(){const e=Ya(this._path);return e===null?null:new me(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class bt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new k(e),i=en(this.ref,e);return new bt(this._node.getChild(t),i,N)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new bt(s,en(this.ref,i),N)))}hasChild(e){const t=new k(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function mi(n,e){return n=z(n),n._checkNotDeleted("ref"),e!==void 0?en(n._root,e):n._root}function en(n,e){return n=z(n),w(n._path)===null?C_("child","path",e):Rl("child","path",e),new me(n._repo,O(n._path,e))}function J_(n,e){n=z(n),nr("push",n._path),Al("push",e,n._path,!0);const t=Ol(n._repo),i=z_(t),s=en(n,i),r=en(n,i);let o;return e!=null?o=X_(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function X_(n,e){n=z(n),nr("set",n._path),Al("set",e,n._path,!1);const t=new It;return D_(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ee(n,e){E_("update",e,n._path);const t=new It;return M_(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function Li(n){n=z(n);const e=new Ll(()=>{}),t=new gi(e);return x_(n._repo,n,t).then(i=>new bt(i,new me(n._repo,n._path),n._queryParams.getIndex()))}class gi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new q_("value",this,new bt(e.snapshotNode,new me(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new K_(this,e,t):null}matches(e){return e instanceof gi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Z_(n,e,t,i,s){const r=new Ll(t,void 0),o=new gi(r);return F_(n._repo,n,o),()=>$_(n._repo,n,o)}function em(n,e,t,i){return Z_(n,"value",e)}class Fl{}class tm extends Fl{constructor(e){super(),this._limit=e,this.type="limitToLast"}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new pn(e._repo,e._path,op(e._queryParams,this._limit),e._orderByCalled)}}function nm(n){if(Math.floor(n)!==n||n<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new tm(n)}class im extends Fl{constructor(){super(...arguments),this.type="orderByKey"}_apply(e){Y_(e,"orderByKey");const t=ap(e._queryParams,Fe);return Q_(t),new pn(e._repo,e._path,t,!0)}}function sm(){return new im}function rm(n,...e){let t=z(n);for(const i of e)t=i._apply(t);return t}Yp(me);e_(me);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _m(n){Kd(Ct),pt(new Xe("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return cm(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Le(jr,Gr,n),Le(jr,Gr,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class mm{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function oe(n,e,t){var i;if(n=z(n),nr("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const s=(i=void 0)!==null&&i!==void 0?i:!0,r=new It,o=(l,c,u)=>{let h=null;l?r.reject(l):(h=new bt(u,new me(n._repo,n._path),N),r.resolve(new mm(c,h)))},a=em(n,()=>{});return V_(n._repo,n._path,e,o,a,s),r.promise}we.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};we.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};_m();const ls={apiKey:"AIzaSyARFa-vzKVmIdxP5xDRXVzasL2ui94eZ-w",authDomain:"market-6e66a.firebaseapp.com",databaseURL:"https://market-6e66a-default-rtdb.firebaseio.com",projectId:"market-6e66a",storageBucket:"market-6e66a.firebasestorage.app",messagingSenderId:"402312269082",appId:"1:402312269082:web:cf304afc54057ea162b0a3"},gm=!!ls.apiKey&&!!ls.databaseURL;let Mt=null,Co=null,To=null;function Rt(){return Mt||(Mt=Ho(ls),Co=zd(Mt),To=fm(Mt)),{app:Mt,auth:Co,db:To}}function vm(){const{auth:n}=Rt();return new Promise(e=>{let t=!1;const i=Mh(n,s=>{t||(t=!0,i(),e(s||null))},()=>e(null));setTimeout(()=>{t||(t=!0,e(n.currentUser||null))},4e3)})}const ym="../STONK-Home/index.html",Fi=2600;function bm(n){return String(n||"").trim().toUpperCase().replace(/[^A-Z0-9]/g,"")}function wm(){return/^(localhost|127\.0\.0\.1|\[::1\])$/.test(location.hostname)||location.protocol==="file:"}function Im(n){const e=bm(n);return ym+(e?`?room=${encodeURIComponent(e)}`:"")}function Em({title:n="STONK Home에서 입장해 주세요",message:e="",roomCode:t="",auto:i=!0}={}){var l;const s=Im(t),r=document.getElementById("stonk-home-gate");r&&r.remove();const o=document.createElement("div");o.id="stonk-home-gate",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),Object.assign(o.style,{position:"fixed",inset:"0",zIndex:"99999",display:"grid",placeItems:"center",padding:"24px",background:"radial-gradient(120% 90% at 50% -10%, rgba(139,108,255,0.22), transparent 60%), rgba(5,6,10,0.94)",backdropFilter:"blur(8px)",color:"#f4f7ff",fontFamily:"Pretendard, Inter, 'Noto Sans KR', system-ui, sans-serif"});const a=i&&!wm();if(o.innerHTML=`
  ...
  `,document.body.appendChild(o),(l=o.querySelector("[data-home-go]"))==null||l.addEventListener("click",c=>{c.preventDefault(),location.href=s}),a){let c=Math.ceil(Fi/1e3);const u=o.querySelector("[data-gate-count]"),h=setInterval(()=>{c-=1,u&&(u.textContent=String(Math.max(0,c))),c<=0&&clearInterval(h)},1e3);setTimeout(()=>{location.href=s},Fi)}return o}const _n="MAIN",or=.002,ar=.01,$l=60*60*1e3,tn=60,Ul={d1:{id:"d1",label:"1일 정기예금",ms:24*3600*1e3,rate:.005,desc:"24시간 · 이자 0.5%"},d3:{id:"d3",label:"3일 정기예금",ms:72*3600*1e3,rate:.018,desc:"72시간 · 이자 1.8%"}},Vl={S:5e7,A:3e7,B:15e6,C:7e6,D:3e6,F:0},Bl={arcade:{id:"arcade",title:"Arcade 손실 완화 보험",premium:3e6,ms:24*3600*1e3,desc:"24시간 · 아케이드 큰 손실 시 일부 완화(예정)"},gacha:{id:"gacha",title:"Gacha 폭망 보호권",premium:5e6,ms:24*3600*1e3,desc:"24시간 · 가챠 과소비 경고 강화"},loan:{id:"loan",title:"대출 유예권",premium:2e6,ms:24*3600*1e3,desc:"24시간 · 대출 위험도 한 단계 완화 표시"}},lr={stable:{id:"stable",title:"안정형 펀드",ms:6*3600*1e3,min:-.01,max:.02,risk:"낮음"},growth:{id:"growth",title:"성장형 펀드",ms:12*3600*1e3,min:-.05,max:.08,risk:"중간"},ipo:{id:"ipo",title:"IPO 청약 상품",ms:24*3600*1e3,min:-.2,max:.35,risk:"높음"},lever:{id:"lever",title:"레버리지 펀드",ms:24*3600*1e3,min:-.4,max:.6,risk:"매우 높음"}},Yn=["NORMAL","SILVER","GOLD","PLATINUM","BLACK"],Wl={NORMAL:0,SILVER:30,GOLD:55,PLATINUM:78,BLACK:92},Hl=.003,jl="GOLD";function G(n){const e=Number(n);return Number.isFinite(e)?e:0}function f(n){return Math.trunc(G(n))}function se(n){return n=Math.round(G(n)),Math.max(0,Math.min(100,n))}function ot(n){return n=se(n),n>=90?"S":n>=75?"A":n>=55?"B":n>=35?"C":n>=15?"D":"F"}function Gl(n){return Vl[n]??0}function Z(n){return f(n).toLocaleString("ko-KR")+"원"}const Cm=n=>mi(Rt().db,`rooms/${_n}/players/${n}`),ae=n=>mi(Rt().db,`rooms/${_n}/players/${n}/cash`),Q=n=>mi(Rt().db,`rooms/${_n}/bank/${n}`),zl=n=>mi(Rt().db,`rooms/${_n}/bank/${n}/tx`);function ql(n){return{balance:0,fixed:{},loanPrincipal:0,loanInterest:0,creditScore:tn,creditGrade:ot(tn),insurances:{},investments:{},vipScore:0,vipTier:"NORMAL",vipVaultBalance:0,lastInterestSettledAt:n,lastVipSettledAt:n,createdAt:n,updatedAt:n}}function Tm(n,e){const t=ql(e),i=n&&typeof n=="object"?n:{};return{nickname:i.nickname||"",balance:Math.max(0,f(i.balance)),fixed:i.fixed&&typeof i.fixed=="object"?i.fixed:{},loanPrincipal:Math.max(0,f(i.loanPrincipal)),loanInterest:Math.max(0,f(i.loanInterest)),creditScore:se(i.creditScore!=null?i.creditScore:tn),creditGrade:i.creditGrade||ot(i.creditScore!=null?i.creditScore:tn),insurances:i.insurances&&typeof i.insurances=="object"?i.insurances:{},investments:i.investments&&typeof i.investments=="object"?i.investments:{},vipScore:se(i.vipScore),vipTier:i.vipTier||"NORMAL",vipVaultBalance:Math.max(0,f(i.vipVaultBalance)),lastInterestSettledAt:f(i.lastInterestSettledAt)||t.lastInterestSettledAt,lastVipSettledAt:f(i.lastVipSettledAt)||t.lastVipSettledAt,createdAt:f(i.createdAt)||e,updatedAt:e}}function te(n){return{nickname:n.nickname||"",balance:Math.max(0,f(n.balance)),fixed:n.fixed||{},loanPrincipal:Math.max(0,f(n.loanPrincipal)),loanInterest:Math.max(0,f(n.loanInterest)),creditScore:se(n.creditScore),creditGrade:ot(n.creditScore),insurances:n.insurances||{},investments:n.investments||{},vipScore:se(n.vipScore),vipTier:n.vipTier||"NORMAL",vipVaultBalance:Math.max(0,f(n.vipVaultBalance)),lastInterestSettledAt:f(n.lastInterestSettledAt),lastVipSettledAt:f(n.lastVipSettledAt)||f(n.lastInterestSettledAt),createdAt:f(n.createdAt),updatedAt:Date.now()}}function cr(n,e){const t=f(n.lastInterestSettledAt)||e,i=Math.max(0,e-t),s=i/864e5,r=s>0?Math.floor(G(n.balance)*or*s):0,o=s>0?Math.floor(G(n.loanPrincipal)*ar*s):0,a=f(n.lastVipSettledAt)||t,l=Math.max(0,e-a)/864e5,c=l>0?Math.floor(G(n.vipVaultBalance)*Hl*l):0,u={...n};return(r>0||o>0)&&(u.balance=Math.max(0,f(n.balance)+r),u.loanInterest=Math.max(0,f(n.loanInterest)+o),u.lastInterestSettledAt=e),c>0&&(u.vipVaultBalance=Math.max(0,f(n.vipVaultBalance)+c),u.lastVipSettledAt=e),{bank:u,freeInt:r,loanInt:o,vipInt:c,elapsed:i}}function Nt(n){return Object.values(n.fixed||{}).reduce((e,t)=>e+f(t&&t.amount),0)}function ur(n){const e=Date.now();return Object.values(n.investments||{}).reduce((t,i)=>!i||i.status==="settled"?t:t+(e>=G(i.maturesAt)?f(dr(i).amount):f(i.principal)),0)}function vi(n,e){return f(n)+f(e.balance)+Nt(e)+f(e.vipVaultBalance)+ur(e)-f(e.loanPrincipal)-f(e.loanInterest)}function Sm(n,e,t){let i=se(n);const s=vi(e,t),r=f(t.loanPrincipal)+f(t.loanInterest);return f(t.loanPrincipal)===0&&(i+=1),s<0&&(i-=5),r>f(e)+f(t.balance)+Nt(t)&&(i-=3),se(i)}function V(n,e,t,i,s,r){return{type:n,title:e,amount:f(t),beforeCash:f(i),afterCash:f(s),memo:r||"",createdAt:Date.now()}}async function W(n,e){await J_(zl(n),e)}async function hr(n){Rt();const e=Date.now(),[t,i,s]=await Promise.all([Li(Cm(n)),Li(Q(n)),Li(rm(zl(n),sm(),nm(20)))]),r=t.val()||{},o=f(r.cash),a=r.nickname||i.val()&&i.val().nickname||"플레이어";let l=Tm(i.val(),e);const c=!i.exists();l.nickname||(l.nickname=a);const u=cr(l,e);let h=!1;const d=u.freeInt>0||u.loanInt>0||u.vipInt>0;c?(l=Ve(l,o),await ee(Q(n),te(l))):u.elapsed>=$l&&d?(l=u.bank,l.creditScore=Sm(l.creditScore,o,l),l=Ve(l,o),await ee(Q(n),te(l)),u.freeInt>0&&await W(n,V("interest","자유예금 이자",u.freeInt,o,o,"")),u.loanInt>0&&await W(n,V("loanInterest","대출 이자",-u.loanInt,o,o,"")),u.vipInt>0&&await W(n,V("vipInterest","VIP 금고 이자",u.vipInt,o,o,"")),h=!0):(l=u.bank,l=Ve(l,o)),l.creditGrade=ot(l.creditScore);const _=s.exists()?Object.entries(s.val()).map(([M,ce])=>({id:M,...ce})).sort((M,ce)=>G(ce.createdAt)-G(M.createdAt)):[],m=Object.values(l.fixed||{}).filter(M=>e>=G(M.maturesAt)).length,C=Object.values(l.investments||{}).filter(M=>M&&M.status!=="settled"&&e>=G(M.maturesAt)).length,P={freeInt:u.freeInt,loanInt:u.loanInt,vipInt:u.vipInt,maturedFixed:m,maturedInvest:C,applied:h};return{uid:n,cash:o,nickname:a,bank:l,tx:_,feed:P,settledNow:h}}async function le(n,e,t){const i=Date.now(),s=cr(e,i);return(s.freeInt>0||s.loanInt>0)&&(s.freeInt>0&&await W(n,V("interest","자유예금 이자",s.freeInt,t,t,"")),s.loanInt>0&&await W(n,V("loanInterest","대출 이자",-s.loanInt,t,t,""))),s.bank}function Qn(n,e,t){return n.creditScore=se(n.creditScore+e),n.creditGrade=ot(n.creditScore),n}async function Kl(n,e,t){if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");let i=await le(n,{...t.bank},t.cash),s=0;const r=await oe(ae(n),l=>{if(l=f(l),s=Math.min(e,l),!(s<=0))return l-s});if(!r.committed||s<=0)throw new Error("보유 현금이 없습니다.");const o=f((r.snapshot&&r.snapshot.val())??t.cash)+s,a=o-s;return i.balance=Math.max(0,f(i.balance)+s),await ee(Q(n),te(i)),await W(n,V("deposit","자유예금 입금",s,o,a,"")),s<e?`입금 완료 (가용 현금 ${Z(s)})`:"입금 완료"}async function Yl(n,e,t){if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");if(e>f(t.bank.balance))throw new Error("예금 잔액이 부족합니다.");let i=await le(n,{...t.bank},t.cash);e>f(i.balance)&&(e=f(i.balance)),i.balance=Math.max(0,f(i.balance)-e),await ee(Q(n),te(i));const s=f(t.cash);return await oe(ae(n),r=>f(r)+e),await W(n,V("withdraw","자유예금 출금",e,s,s+e,"")),"출금 완료"}async function Ql(n,e,t,i){const s=Ul[e];if(!s)throw new Error("상품을 선택하세요.");if(t=f(t),t<=0)throw new Error("금액을 확인하세요.");if(t>f(i.cash))throw new Error("보유 현금이 부족합니다.");let r=await le(n,{...i.bank},i.cash);if(!(await oe(ae(n),u=>{if(u=f(u),!(u<t))return u-t})).committed)throw new Error("보유 현금이 부족합니다.");const a=Date.now(),l="f"+a.toString(36);r.fixed=r.fixed||{},r.fixed[l]={id:l,product:e,label:s.label,amount:t,rate:s.rate,startedAt:a,maturesAt:a+s.ms},await ee(Q(n),te(r));const c=f(i.cash);return await W(n,V("fixedOpen",`${s.label} 가입`,t,c,c-t,"")),`${s.label} 가입 완료`}async function Jl(n,e,t){let i=await le(n,{...t.bank},t.cash);const s=i.fixed&&i.fixed[e];if(!s)throw new Error("정기예금을 찾을 수 없습니다.");const r=f(s.amount);delete i.fixed[e],await ee(Q(n),{...te(i),[`fixed/${e}`]:null});const o=f(t.cash);return await oe(ae(n),a=>f(a)+r),await W(n,V("fixedCancel",`${s.label} 중도해지 (이자 미지급)`,r,o,o+r,"만기 전 해지")),"중도해지 — 원금만 반환되었습니다."}async function Xl(n,e,t){let i=await le(n,{...t.bank},t.cash);const s=i.fixed&&i.fixed[e];if(!s)throw new Error("정기예금을 찾을 수 없습니다.");if(Date.now()<f(s.maturesAt))throw new Error("아직 만기가 되지 않았습니다.");const r=f(s.amount),o=Math.floor(r*G(s.rate)),a=r+o;delete i.fixed[e],i=Qn(i,1,t.cash),await ee(Q(n),{...te(i),[`fixed/${e}`]:null});const l=f(t.cash);return await oe(ae(n),c=>f(c)+a),await W(n,V("fixedClaim",`${s.label} 만기수령 (원금+이자)`,a,l,l+a,`이자 ${Z(o)}`)),`만기 수령 완료 (+${Z(o)} 이자)`}async function Zl(n,e,t){if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");let i=await le(n,{...t.bank},t.cash);const s=ot(i.creditScore),r=Gl(s),o=f(i.loanPrincipal);if(r<=0)throw new Error("현재 신용등급(F)으로는 대출이 불가합니다.");if(o+e>r)throw new Error(`대출 한도 초과 (한도 ${Z(r)}, 현재 잔액 ${Z(o)})`);i.loanPrincipal=o+e,i=Qn(i,-3,t.cash),await ee(Q(n),te(i));const a=f(t.cash);return await oe(ae(n),l=>f(l)+e),await W(n,V("loan","대출 실행",e,a,a+e,`잔액 ${Z(i.loanPrincipal)}`)),`대출 완료 (+${Z(e)})`}async function cs(n,e,t){if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");if(e>f(t.cash))throw new Error("보유 현금이 부족합니다.");let i=await le(n,{...t.bank},t.cash);const s=f(i.loanPrincipal)+f(i.loanInterest);if(s<=0)throw new Error("상환할 대출이 없습니다.");const r=Math.min(e,s);if(!(await oe(ae(n),d=>{if(d=f(d),!(d<r))return d-r})).committed)throw new Error("보유 현금이 부족합니다.");let a=r;const l=Math.min(a,f(i.loanInterest));i.loanInterest=Math.max(0,f(i.loanInterest)-l),a-=l;const c=Math.min(a,f(i.loanPrincipal));i.loanPrincipal=Math.max(0,f(i.loanPrincipal)-c);const u=i.loanPrincipal<=0;u?(i.loanInterest=0,i=Qn(i,5,t.cash)):i=Qn(i,1,t.cash),await ee(Q(n),te(i));const h=f(t.cash);return await W(n,V("repay",u?"대출 전액 상환":"대출 상환",-r,h,h-r,`이자 ${Z(l)} · 원금 ${Z(c)}`)),u?"전액 상환 완료 🎉":`상환 완료 (이자 ${Z(l)} · 원금 ${Z(c)})`}function ec(n){n=se(n);let e="NORMAL";for(const t of Yn)n>=Wl[t]&&(e=t);return e}function km(n){return{NORMAL:"일반",SILVER:"실버",GOLD:"골드",PLATINUM:"플래티넘",BLACK:"블랙"}[n]||"일반"}function Ve(n,e){const t={...n},i=f(n.balance)+Nt(n)+f(n.vipVaultBalance),s=vi(e,n);let r=0;return r+=Math.min(40,Math.floor(i/25e5)),r+=Math.min(25,Math.floor(Math.max(0,s)/4e6)),r+=Object.keys(n.fixed||{}).length?8:0,r+=Object.keys(n.investments||{}).length?8:0,r+=Object.keys(n.insurances||{}).length?5:0,r+=f(n.loanPrincipal)===0?6:0,r+=Math.min(8,se(n.creditScore)>=75?8:0),t.vipScore=se(r),t.vipTier=ec(t.vipScore),t}function Am(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619);return e>>>0}function So(n){let e=(Am(String(n))||1)>>>0;return e^=e<<13,e>>>=0,e^=e>>17,e^=e<<5,e>>>=0,e%1e5/1e5}function dr(n){const e=lr[n.productType]||{min:G(n.expectedMinRate),max:G(n.expectedMaxRate)},t=So(n.seed),i=So(n.seed+"x"),s=(t+i)/2,r=.45,o=e.min+(e.max-e.min)*(s*(1-r)+r*.5+(s-.5)*r),a=Math.max(e.min,Math.min(e.max,o)),l=f(n.principal),c=Math.max(0,Math.round(l*(1+a)));return{rate:a,amount:c,profit:c-l}}function tc(n){return n>=.25?["대박","win"]:n>=.05?["성공","ok"]:n>-.02?["보합","flat"]:n>-.2?["손실","lose"]:["폭락","crash"]}function Rm(n,e){if(vi(n,e)<0)return{key:"severe",label:"심각",tone:"danger"};const i=f(e.loanPrincipal)+f(e.loanInterest);if(i<=0)return{key:"safe",label:"안전",tone:"ok"};const s=f(n)+f(e.balance)+Nt(e)+f(e.vipVaultBalance)+ur(e),r=s>0?i/s:1;return r<.3?{key:"ok",label:"관리 가능",tone:"ok",ratio:r}:r<.7?{key:"warn",label:"주의",tone:"warn",ratio:r}:{key:"high",label:"위험",tone:"danger",ratio:r}}function Nm(n,e){const t=f(e.balance)+Nt(e)+f(e.vipVaultBalance);if(t<=0)return{label:"미이용",tone:"muted"};const i=[];return Object.keys(e.fixed||{}).length&&i.push("장기 예치 중"),t>f(n)&&i.push("보수적 운용"),i.unshift("안정 자산 보유"),{label:i.join(" · "),tone:"ok"}}function nc(n,e){return n&&n.status!=="expired"&&G(n.expiresAt)>(e||Date.now())}function ic(n,e){return e=e||Date.now(),Object.values(n.insurances||{}).filter(t=>nc(t,e))}async function Pm(n,e,t){const i=Bl[e];if(!i)throw new Error("보험 상품을 선택하세요.");let s=await le(n,{...t.bank},t.cash);const r=Date.now();if(ic(s,r).some(c=>c.type===e))throw new Error("이미 가입 중인 보험입니다.");if(i.premium>f(t.cash))throw new Error("보유 현금이 부족합니다.");if(!(await oe(ae(n),c=>{if(c=f(c),!(c<i.premium))return c-i.premium})).committed)throw new Error("보유 현금이 부족합니다.");const a="ins"+r.toString(36);s.insurances=s.insurances||{},s.insurances[a]={id:a,type:e,title:i.title,premium:i.premium,status:"active",startedAt:r,expiresAt:r+i.ms,usedAt:0,createdAt:r},s=Ve(s,t.cash),await ee(Q(n),te(s));const l=f(t.cash);return await W(n,V("insurance_buy",`${i.title} 가입`,-i.premium,l,l-i.premium,"")),`${i.title} 가입 완료`}async function Om(n,e,t,i){const s=lr[e];if(!s)throw new Error("투자상품을 선택하세요.");if(t=f(t),t<=0)throw new Error("금액을 확인하세요.");if(t>f(i.cash))throw new Error("보유 현금이 부족합니다.");let r=await le(n,{...i.bank},i.cash);if(!(await oe(ae(n),h=>{if(h=f(h),!(h<t))return h-t})).committed)throw new Error("보유 현금이 부족합니다.");const a=Date.now(),l="inv"+a.toString(36),c=n+":"+l+":"+a;r.investments=r.investments||{},r.investments[l]={id:l,productType:e,title:s.title,principal:t,expectedMinRate:s.min,expectedMaxRate:s.max,status:"active",seed:c,startedAt:a,maturesAt:a+s.ms,resultRate:null,resultAmount:null,settledAt:0,createdAt:a},r=Ve(r,i.cash),await ee(Q(n),te(r));const u=f(i.cash);return await W(n,V("investment_buy",`${s.title} 가입`,-t,u,u-t,`위험도 ${s.risk}`)),`${s.title} 가입 완료`}async function xm(n,e,t){let i=await le(n,{...t.bank},t.cash);const s=i.investments&&i.investments[e];if(!s)throw new Error("투자상품을 찾을 수 없습니다.");if(Date.now()<G(s.maturesAt))throw new Error("아직 만기가 되지 않았습니다.");if(s.status==="settled")throw new Error("이미 정산된 상품입니다.");const r=dr(s);delete i.investments[e],i=Ve(i,t.cash),await ee(Q(n),{...te(i),[`investments/${e}`]:null});const o=f(t.cash);await oe(ae(n),l=>f(l)+r.amount);const[a]=tc(r.rate);return await W(n,V("investment_settle",`${s.title} 정산 · ${a}`,r.amount,o,o+r.amount,`${(r.rate*100).toFixed(1)}%`)),`${a}! ${r.profit>=0?"+":"−"}${Z(Math.abs(r.profit))} (${(r.rate*100).toFixed(1)}%)`}function sc(n){return Yn.indexOf(n.vipTier||"NORMAL")>=Yn.indexOf(jl)}async function Dm(n,e,t){if(!sc(t.bank))throw new Error("VIP 금고는 GOLD 등급부터 이용 가능합니다.");if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");let i=await le(n,{...t.bank},t.cash),s=0;if(!(await oe(ae(n),a=>{if(a=f(a),s=Math.min(e,a),!(s<=0))return a-s})).committed||s<=0)throw new Error("보유 현금이 없습니다.");i.vipVaultBalance=Math.max(0,f(i.vipVaultBalance)+s),i=Ve(i,t.cash),await ee(Q(n),te(i));const o=f(t.cash);return await W(n,V("vip_deposit","VIP 금고 입금",s,o,o-s,"")),s<e?`VIP 금고 입금 (가용 ${Z(s)})`:"VIP 금고 입금 완료"}async function Mm(n,e,t){if(e=f(e),e<=0)throw new Error("금액을 확인하세요.");if(e>f(t.bank.vipVaultBalance))throw new Error("VIP 금고 잔액이 부족합니다.");let i=await le(n,{...t.bank},t.cash);e>f(i.vipVaultBalance)&&(e=f(i.vipVaultBalance)),i.vipVaultBalance=Math.max(0,f(i.vipVaultBalance)-e),i=Ve(i,t.cash),await ee(Q(n),te(i));const s=f(t.cash);return await oe(ae(n),r=>f(r)+e),await W(n,V("vip_withdraw","VIP 금고 출금",e,s,s+e,"")),"VIP 금고 출금 완료"}const Lm=Object.freeze(Object.defineProperty({__proto__:null,FIXED_PRODUCTS:Ul,FREE_RATE_DAY:or,INIT_CREDIT:tn,INSURANCE_PRODUCTS:Bl,INVESTMENT_PRODUCTS:lr,LOAN_LIMIT_BY_GRADE:Vl,LOAN_RATE_DAY:ar,MIN_AUTOSETTLE_MS:$l,ROOM:_n,VIP_TIERS:Yn,VIP_TIER_MIN:Wl,VIP_VAULT_MIN_TIER:jl,VIP_VAULT_RATE_DAY:Hl,activeInsurances:ic,buyInsurance:Pm,buyInvestment:Om,cancelFixed:Jl,claimFixed:Xl,claimInvestment:xm,clampScore:se,defaultBank:ql,depositFree:Kl,depositStability:Nm,depositVip:Dm,fixedTotal:Nt,gradeFromScore:ot,insuranceActive:nc,int:f,investLabel:tc,investOutcome:dr,investmentsValue:ur,loadState:hr,loanLimit:Gl,loanRisk:Rm,netWorth:vi,num:G,openFixed:Ql,repayLoan:cs,settleInterest:cr,takeLoan:Zl,txItem:V,vipTierFromScore:ec,vipTierLabel:km,vipVaultUnlocked:sc,withdrawFree:Yl,withdrawVip:Mm,won:Z},Symbol.toStringTag,{value:"Module"})),{won:b,int:x,num:j,fixedTotal:rc,netWorth:oc,gradeFromScore:yi,loanLimit:fr,FIXED_PRODUCTS:Fm,INSURANCE_PRODUCTS:ac,INVESTMENT_PRODUCTS:$m,investmentsValue:Um,investOutcome:lc,investLabel:Vm,loanRisk:Bm,depositStability:Wm,activeInsurances:Hm,insuranceActive:ko,buyInsurance:jm,buyInvestment:Gm,claimInvestment:zm,vipTierLabel:us,vipVaultUnlocked:cc,depositVip:qm,withdrawVip:Km,VIP_VAULT_RATE_DAY:Ym}=Lm,Qm="yaV8N60yIiUggaWNpNF2VhkCwxb2",Jm="tomem@naver.com",q=document.getElementById("app");let g=null,uc=!1,Jn="dashboard",Lt="all",$i=!1,Ao=!1;Xm();async function Xm(){if(!gm){Ro("Firebase 설정이 비어 있습니다.");return}eg();let n=null;try{n=await vm()}catch{}if(!n){Em({message:"STONK Home에서 로그인 후 이용해 주세요. 같은 계정의 자산이 그대로 연결됩니다."}),tg();return}try{uc=n.uid===Qm||String(n.email||"").toLowerCase()===Jm,g=await hr(n.uid),Ht(),ig()}catch(e){console.error("[bank] 로드 실패:",e),Ro("은행 데이터를 불러오지 못했습니다: "+(e&&e.message))}}async function Zm(){if(g){try{g=await hr(g.uid)}catch(n){console.warn(n)}Ht()}}function U(n){return String(n??"").replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e])}function Xn(n,e="ok"){const t=document.createElement("div");t.className="bk-toast "+e,t.textContent=n,document.body.appendChild(t),setTimeout(()=>{t.classList.add("hide"),setTimeout(()=>t.remove(),280)},2200)}async function ne(n){if(!$i){$i=!0;try{const e=await n();e&&Xn(e,"ok"),await Zm()}catch(e){Xn(e&&e.message||"오류가 발생했습니다.","err")}finally{$i=!1}}}function ke(n){const e=document.getElementById(n);return e?Math.floor(Number(e.value)||0):0}function eg(){q.innerHTML='<div class="bk-center"><div class="bk-spin"></div><p>STONK Bank 연결 중…</p></div>'}function Ro(n){q.innerHTML=`<div class="bk-center"><h2>⚠️ 오류</h2><p>${U(n)}</p><a class="bk-btn primary" href="../STONK-Home/index.html">STONK Home으로</a></div>`}function tg(){q.innerHTML=`<div class="bk-center">
  ...
  `,mg()}function ng(n){return n==="deposit"?ag():n==="loan"?lg():n==="insurance"?hg():n==="invest"?dg():n==="vip"?fg():n==="history"?ug():rg()}function ig(){if(Ao||!g||!g.feed)return;Ao=!0;const n=g.feed,e=[];n.applied&&n.freeInt>0&&e.push(`자유예금 이자 +${b(n.freeInt)} 정산`),n.applied&&n.vipInt>0&&e.push(`VIP 금고 이자 +${b(n.vipInt)} 정산`),n.applied&&n.loanInt>0&&e.push(`대출 이자 +${b(n.loanInt)} 반영`),n.maturedFixed>0&&e.push(`정기예금 만기 ${n.maturedFixed}건`),n.maturedInvest>0&&e.push(`투자 정산 가능 ${n.maturedInvest}건`),e.length&&Xn(e.join(" · "),n.loanInt>0&&!n.freeInt?"warn":"ok")}function sg(){const n=g.feed;if(!n)return"";const e=[];return n.applied&&n.freeInt>0&&e.push(`<span class="ok">자유예금 이자 +${b(n.freeInt)}</span>`),n.applied&&n.vipInt>0&&e.push(`<span class="ok">VIP 금고 이자 +${b(n.vipInt)}</span>`),n.applied&&n.loanInt>0&&e.push(`<span class="warn">대출 이자 +${b(n.loanInt)}</span>`),n.maturedFixed>0&&e.push(`<span>정기예금 만기 ${n.maturedFixed}건</span>`),n.maturedInvest>0&&e.push(`<span>투자 정산 가능 ${n.maturedInvest}건</span>`),e.length?`<div class="bk-feed">🔔 ${e.join(" · ")}</div>`:""}function rg(){const n=g.bank,e=yi(n.creditScore),t=se(n.creditScore),i=oc(g.cash,n),s=Bm(g.cash,n),r=Wm(g.cash,n),o=g.feed||{},a=o.applied?x(o.freeInt)+x(o.vipInt):0,l=Object.values(n.investments||{}),c=l.filter(_=>Date.now()>=j(_.maturesAt)).length,u=l.reduce((_,m)=>_+(Date.now()>=j(m.maturesAt)?lc(m).profit:0),0),h=Hm(n),d=(g.tx||[]).slice(0,3);return`
    ...
    <div class="bk-grid">
      ...
      <div class="bk-card credit">
        ...
        <div class="bk-credit"><div class="bk-grade-big g-${e}">${e}</div><div class="bk-score"><div class="bk-score-bar"><span style="width:${t}%"></span></div><small>${t} / 100 · 한도 ${b(fr(e))}</small></div></div>
        <div class="bk-row"><span>VIP 등급</span><b>${No(n.vipTier)} <small class="muted">${n.vipScore}점</small></b></div>
      </div>

      <div class="bk-card">
        <h3>리스크 진단</h3>
        <div class="bk-row"><span>대출 위험도</span><b>${og(s.label,s.tone)}</b></div>
      ...
      <div class="bk-card">
        <h3>VIP</h3>
        <div class="bk-row"><span>등급 / 점수</span><b>${No(n.vipTier)} ${n.vipScore}점</b></div>
    ...
    </div>`}function og(n,e){return`<span class="bk-status ${e}">${U(n)}</span>`}function No(n){return`<span class="bk-vip v-${n||"NORMAL"}">${U(us(n))}</span>`}function ag(){const n=g.bank,e=Object.values(n.fixed||{}).sort((i,s)=>j(i.maturesAt)-j(s.maturesAt)),t=Date.now();return`
    <div class="bk-grid">
      <div class="bk-card">
    ...
    </div>`}function lg(){const n=g.bank,e=yi(n.creditScore),t=fr(e),i=Math.max(0,t-x(n.loanPrincipal));return`
    <div class="bk-grid">
    ...
    </div>`}const cg={deposit:["입금","in"],withdraw:["출금","out"],fixedOpen:["정기가입","out"],fixedCancel:["중도해지","in"],fixedClaim:["만기수령","in"],loan:["대출","in"],repay:["상환","out"],interest:["예금이자","in"],loanInterest:["대출이자","out"],vipInterest:["VIP이자","in"],insurance_buy:["보험가입","out"],insurance_expired:["보험만료","out"],insurance_used:["보험사용","in"],investment_buy:["투자가입","out"],investment_settle:["투자정산","in"],investment_cancel:["투자해지","in"],vip_deposit:["VIP입금","in"],vip_withdraw:["VIP출금","out"]},Po={all:null,deposit:["deposit","withdraw"],fixed:["fixedOpen","fixedCancel","fixedClaim"],loan:["loan","repay"],interest:["interest","loanInterest","vipInterest"],insurance:["insurance_buy","insurance_expired","insurance_used"],invest:["investment_buy","investment_settle","investment_cancel"],vip:["vip_deposit","vip_withdraw"]},Ui={all:"전체",deposit:"예금",fixed:"정기예금",loan:"대출",interest:"이자",insurance:"보험",invest:"투자",vip:"VIP"};function dc(n){const e=cg[n.type]||[n.type,"in"],t=x(n.amount),i=t>=0?"plus":"minus";return`<li><span class="bk-tx-badge t-${e[1]}">${e[0]}</span>
    <div class="bk-tx-mid"><b>${U(n.title||e[0])}</b><small>${_g(n.createdAt)}${n.memo?" · "+U(n.memo):""}</small></div>
    <b class="bk-tx-amt ${i}">${t>=0?"+":"−"}${b(Math.abs(t))}</b></li>`}function ug(){const n=g.tx||[],e=Po[Lt],t=(e?n.filter(i=>e.includes(i.type)):n).slice(0,50);return`<div class="bk-card">
    <h3>거래내역 <small class="muted">${Ui[Lt]} · ${t.length}건</small></h3>
    <div class="bk-filters">
      ${Object.keys(Po).map(i=>`<button class="bk-chipbtn ${Lt===i?"active":""}" data-filter="${i}">${Ui[i]}</button>`).join("")}
    </div>
    ...
    <div class="bk-grid">
      ${Object.values(ac).map(i=>{const s=t.find(r=>r.type===i.id&&ko(r,e));return`<div class="bk-card">
    ...
    <div class="bk-card">
      <h3>내 보험 내역</h3>
      ${t.length?`<div class="bk-fixedlist">${t.sort((i,s)=>j(s.startedAt)-j(i.startedAt)).map(i=>{const s=ko(i,e);return`<div class="bk-fixed ${s?"matured":""}">
    ...
    </div>`}function pg(n){return Math.round(n/36e5)+"시간"}function Zn(n){const e=Math.floor(n/36e5),t=Math.floor(n%36e5/6e4);return e>0?`${e}시간 ${t}분`:`${t}분`}function _g(n){const e=new Date(j(n)||Date.now()),t=i=>(i<10?"0":"")+i;return`${e.getMonth()+1}/${t(e.getDate())} ${t(e.getHours())}:${t(e.getMinutes())}`}function mg(){const n=q.querySelector("[data-home]");n&&n.addEventListener("click",e=>{e.preventDefault(),Jn="dashboard",window.scrollTo(0,0),Ht()}),q.querySelectorAll("[data-tab]").forEach(e=>e.addEventListener("click",()=>{Jn=e.dataset.tab,Ht()})),q.querySelectorAll("[data-fill]").forEach(e=>e.addEventListener("click",()=>gg(e.dataset.fill))),q.querySelectorAll("[data-act]").forEach(e=>e.addEventListener("click",()=>vg(e.dataset.act))),q.querySelectorAll("[data-claim]").forEach(e=>e.addEventListener("click",()=>ne(()=>Xl(g.uid,e.dataset.claim,g)))),q.querySelectorAll("[data-cancel]").forEach(e=>e.addEventListener("click",()=>{confirm("정기예금을 중도해지하면 이자 없이 원금만 돌려받습니다. 해지할까요?")&&ne(()=>Jl(g.uid,e.dataset.cancel,g))})),q.querySelectorAll("[data-claiminv]").forEach(e=>e.addEventListener("click",()=>ne(()=>zm(g.uid,e.dataset.claiminv,g)))),q.querySelectorAll("[data-buyins]").forEach(e=>e.addEventListener("click",()=>{const t=ac[e.dataset.buyins];t&&confirm(`${t.title} 가입비 ${b(t.premium)}을(를) 결제할까요? (게임머니)`)&&ne(()=>jm(g.uid,e.dataset.buyins,g))})),q.querySelectorAll("[data-filter]").forEach(e=>e.addEventListener("click",()=>{Lt=e.dataset.filter,Ht()}))}function gg(n){const[e,t]=n.split(":"),i=document.getElementById(e);if(!i)return;const s=g.bank;let r=0;t==="maxin"?r=x(g.cash):t==="maxout"?r=x(s.balance):t==="maxvip"?r=x(s.vipVaultBalance):t==="maxloan"&&(r=Math.max(0,fr(yi(s.creditScore))-x(s.loanPrincipal))),i.value=r>0?r:""}function vg(n){const e=g.bank;if(n==="deposit")return ne(()=>Kl(g.uid,ke("freeAmt"),g));if(n==="withdraw")return ne(()=>Yl(g.uid,ke("freeAmt"),g));if(n==="openFixed"){const t=(q.querySelector('input[name="fixedProd"]:checked')||{}).value||"d1";return ne(()=>Ql(g.uid,t,ke("fixedAmt"),g))}if(n==="loan")return ne(()=>Zl(g.uid,ke("loanAmt"),g));if(n==="repay")return ne(()=>cs(g.uid,ke("repayAmt"),g));if(n==="buyInvest"){const t=(q.querySelector('input[name="invProd"]:checked')||{}).value||"stable";return ne(()=>Gm(g.uid,t,ke("invAmt"),g))}if(n==="vipDeposit")return ne(()=>qm(g.uid,ke("vipAmt"),g));if(n==="vipWithdraw")return ne(()=>Km(g.uid,ke("vipAmt"),g));if(n==="repayAll"){const t=x(e.loanPrincipal)+x(e.loanInterest);if(t<=0){Xn("상환할 대출이 없습니다.","err");return}return ne(()=>cs(g.uid,t,g))}}
